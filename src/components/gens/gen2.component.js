                ...
                if (male.father_id == father_id && male.mother_id == mother_id) {
                    return (
                        ...
                        <h1>Generation 2</h1>
                            ...
                            <Gen3 father_id={male.id} mother_id={male.spouse_id}  males={males} females={females} />
                        </div>
                    );
                }
            })}
                    ...
                    return (
                        ...
                        <h1>Generation 2</h1>
                            <h1>{female.id} --- {female.name} === {males.map((male, index) => {
                                ...
                                <Gen3 father_id={female.spouse_id} mother_id={female.id}  males={males} females={females} />
                        </div>
                    );
                }
            })}
